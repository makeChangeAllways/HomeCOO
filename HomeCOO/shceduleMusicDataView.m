...
@interface scheduleMusicDataView ()<UIPickerViewDelegate,UIPickerViewDataSource>{
...
@implementation scheduleMusicDataView
...
- (void)initViews{
    ...
    stateLab.text = dataCenter.songName;
