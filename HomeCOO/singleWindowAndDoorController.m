//
//  singleWindowAndDoorController.m
//  HomeCOO
//
//  Created by tgbus on 16/5/10.
...
@interface singleWindowAndDoorController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
...
@property(nonatomic,weak)  windowCollectionViewCell *cell;
...
static NSString *string = @"windowCollectionViewCell";

@implementation singleWindowAndDoorController
...
- (NSInteger)collectionView:(UICollectionView *)collectionView numberOfItemsInSection:(NSInteger)section{
    ...
    if ([_dataCenter.gatewayNo isEqualToString:@"0"] | !_dataCenter.gatewayNo ) {
        ...
        count = [deviceMessageTool queryWithWindowsDevices:devicess].count;
...
- (void)enterChangeButton:(UIButton *)btn {
    ...
    windowCollectionViewCell *cell = (windowCollectionViewCell *)[[[btn superview]superview]superview];//获取cell
...
-(void)addUICollectionView{
    ...
    [collectionView registerClass:[windowCollectionViewCell class] forCellWithReuseIdentifier:string];
...
-(void)setNavBar{
    ...
    //创建一个导航栏集合
    UINavigationItem *navItem = [[UINavigationItem alloc] initWithTitle:@"门窗"];
