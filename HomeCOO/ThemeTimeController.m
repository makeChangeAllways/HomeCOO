...
@interface ThemeTimeController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
...
@implementation ThemeTimeController
-(NSArray*)theme{
...
- (void)enterChangeButton:(UIButton *)btn {
    ...
    themMessageModel *theme = self.theme[indexPathAll.row];
    ...
    scheduleThemeTaskController * nextVc = [[scheduleThemeTaskController  alloc]init];
