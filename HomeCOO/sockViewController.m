...
@interface sockViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
...
@property(nonatomic,weak) themeSockView *cell;
...
static NSString *string = @"themeSockView";
...
-(void)addUICollectionView{
    ...
    [collectionView registerClass:[themeSockView class] forCellWithReuseIdentifier:string];
...
- (void)checkBox:(UIButton *)btn {
    ...
    themeSockView *cell = (themeSockView *)[[[btn superview]superview]superview];//获取cell
...
- (void)enterChangeButton:(UIButton *)btn {
   ...
   // deviceMessage *state = [[deviceMessage  alloc]init];2016年9月7日 注释掉
