...
@interface HCDaterView ()<UITableViewDelegate,UITableViewDataSource>{
...
- (void)initViews{
    ...
    cancelBtn.frame = CGRectMake(0, CGRectGetMaxY(myTableView.frame), daterContentView.frame.size.width/2, daterLab.h);
    ...
    sureBtn.frame = CGRectMake(CGRectGetMaxX(cancelBtn.frame), CGRectGetMaxY(myTableView.frame), daterContentView.frame.size.width/2, daterLab.h);
