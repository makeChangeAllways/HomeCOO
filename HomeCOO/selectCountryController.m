...
@interface selectCountryController ()
...
-(void)initComponent{
    ...
    //创建一个导航栏集合
    UINavigationItem *navItem = [[UINavigationItem alloc] initWithTitle:@"选择国家"];
    ...
    //创建一个左边按钮
    UIBarButtonItem *leftButton = [[UIBarButtonItem alloc] initWithTitle:nil style:UIBarButtonItemStyleBordered target:self action:@selector(onBackPress)];
    ...
    UITableView *tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, navBar.bounds.size.height, width, height-NAVIGATION_BAR_HEIGHT) style:UITableViewStylePlain];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    dataCenter.countyrCode =[dataArray objectAtIndex:1];
