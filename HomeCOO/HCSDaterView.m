...
#define daterConterViewHeight   [UIScreen  mainScreen].bounds.size.height /2.5


@interface HCSDaterView ()<UITableViewDelegate,UITableViewDataSource>{
...
- (void)initViews{
    ...
    daterLab=[[UILabel alloc]initWithFrame:CGRectMake(0, 0, daterContentView.w, daterContentView.h/3+5)];
    ...
    myTableView = [[UITableView alloc]initWithFrame:CGRectMake(0, daterLab.h, daterContentView.w, daterContentView.h/3)];
    ...
    cancelBtn.frame = CGRectMake(0, CGRectGetMaxY(myTableView.frame), daterContentView.frame.size.width/2, daterContentView.h/3-5);
    ...
    sureBtn.frame = CGRectMake(CGRectGetMaxX(cancelBtn.frame), CGRectGetMaxY(myTableView.frame), daterContentView.frame.size.width/2, daterContentView.h/3-5);
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(daterViewClicked:)]) {
        
        [self.delegate daterViewClicked:self];
    }
