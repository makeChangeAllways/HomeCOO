...
-(void)onSingleTap{
    ...
    if (self.isShowControllerBar) {
        ...
        [UIView transitionWithView:self.controllerView duration:0.2 options:UIViewAnimationCurveEaseOut animations:^{
        ...
        self.isShowControllerBar = !self.isShowControllerBar;
        [UIView transitionWithView:self.controllerView duration:0.2 options:UIViewAnimationCurveEaseOut
            animations:^{
