...
-(NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section{
    return [[[FListManager sharedFList] getSetedPasswordLocalDevices] count];
}
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    LocalDevice *localDevice = [[[FListManager sharedFList] getSetedPasswordLocalDevices] objectAtIndex:indexPath.row];
    cell.rightImage = @"ic_local_device_add.png";
    cell.contentText = localDevice.contactId;
