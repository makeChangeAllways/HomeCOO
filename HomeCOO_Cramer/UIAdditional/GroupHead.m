...
//            UILabel *statusLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.frame.size.width-30, 0, STATUS_LABEL_WIDTH, self.frame.size.height)];
            UIImageView *statusLabel = [[UIImageView alloc] initWithFrame:CGRectMake(self.frame.size.width-30, 20, 15, 6)];
            ...
            self.statusLabel.frame = CGRectMake(self.frame.size.width-30, 20, 15, 6);
...
//        _statusLabel.text = @">";
        _statusLabel.image =[UIImage imageNamed:@"call_guan"];
    }else{
//        _statusLabel.text = @"v";
         _statusLabel.image =[UIImage imageNamed:@"call_open"];
    }
}
