...
-(void)layoutSubviews{
    ...
    if(!self.mainView){
        ...
        if(leftIconImg==nil){
            leftIconImg = [UIImage imageNamed:@"bgImageBig.jpg"];
        }
...
//        right_icon.backgroundColor = [UIColor blackColor];
...
-(void)normalButton:(UIView*)view{
    [UIView transitionWithView:self.mainView duration:0.3 options:UIViewAnimationCurveEaseInOut
                    animations:^{
                        self.mainView.backgroundColor = XWhite;
                    }
