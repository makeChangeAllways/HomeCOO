...
//    if(!self.lineview){
//        UIImageView *imagebg = [[UIImageView alloc] initWithFrame:CGRectMake(0, 180, VIEWWIDTH, 45)];
//        
//        imagebg.backgroundColor = [UIColor colorWithWhite:0.5 alpha:0.5];
//        
//        
//        [self.contentView addSubview:imagebg];
//        self.lineview = imagebg;
//    }else{
//        self.lineview.frame = CGRectMake(0, 180, VIEWWIDTH, 0.5);
//        self.lineview.backgroundColor = [UIColor colorWithWhite:0.5 alpha:0.5];
