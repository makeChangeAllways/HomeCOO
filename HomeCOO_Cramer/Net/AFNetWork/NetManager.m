...
//static NSString *server1 = @"http://192.168.1.222/";
//static NSString *server2 = @"http://192.168.1.222/";
//static NSString *server3 = @"http://192.168.1.222/";
//static NSString *server4 = @"http://192.168.1.222/";
...
//            NSDictionary *dic = [NSDictionary diction];
...
- (void)getAccountInfo:(NSString *)username sessionId:(NSString *)sessionId callBack:(void (^)(id))callBack{
   ...
   // NSLog(@"  == currentServer = %@",currentServer);//currentServer = http://api2.cloudlinks.cn/
