...
-(void)layoutSubviews{
    ...
    if(!self.leftLabelView){
        ...
        UILabel *textLabel = [[UILabel alloc] initWithFrame:CGRectMake(30, 0, [Language isEqualToString:@"en"] ? LEFT_LABEL_WIDTH : Left_Label_ch, BAR_BUTTON_HEIGHT)];
        ...
        self.leftLabelView.frame = CGRectMake(30, 0, [Language isEqualToString:@"en"] ? LEFT_LABEL_WIDTH : Left_Label_ch, BAR_BUTTON_HEIGHT);
