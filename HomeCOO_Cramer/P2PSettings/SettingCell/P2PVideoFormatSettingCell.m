...
-(void)layoutSubviews{
    ...
    if (!self.formatbtn) {
        ...
        button.frame=CGRectMake(cellWidth-83, (cellHeight-20)/2, 73, 20);
//        [button setImage:[UIImage imageNamed:@"media_on"] forState:UIControlStateNormal];
//        [button setImage:[UIImage imageNamed:@"media_off"] forState:UIControlStateSelected];
        self.formatbtn=button;


    }else{
        
        [self.contentView addSubview:self.formatbtn];
        self.formatbtn.frame=CGRectMake(cellWidth-83, (cellHeight-20)/2, 73, 20);
//        [self.formatbtn setImage:[UIImage imageNamed:@"media_on"] forState:UIControlStateNormal];
//        [self.formatbtn setImage:[UIImage imageNamed:@"media_off"] forState:UIControlStateSelected];
