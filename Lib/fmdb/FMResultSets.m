...
@implementation FMResultSets
@synthesize query=_query;
@synthesize statement=_statement;

+ (instancetype)resultSetWithStatement:(FMStatements *)statement usingParentDatabase:(FMDatabasess*)aDB {
    
    FMResultSets *rs = [[FMResultSets alloc] init];
...
- (void)setParentDB:(FMDatabasess *)newDb {
    _parentDB = newDb;
}
