...
#import "FMResultSets.h"
#import "FMDatabasePools.h"
...
@interface FMDatabasess : NSObject  {
...
- (FMResultSets *)executeQueryWithFormat:(NSString*)format, ... NS_FORMAT_FUNCTION(1,2);
...
@interface FMStatements : NSObject {
    void *_statement;
    NSString *_query;
    long _useCount;
    BOOL _inUse;
